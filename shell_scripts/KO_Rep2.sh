...
#mkdir counts 
featureCounts -p -T 8 -s 0 -Q 10 -a GRCh38.gtf -o counts/GSE228167_Rep2_featureCounts.txt alignments.namesorted.bam
...
cut -f1,7 counts/GSE228167_Rep2_featureCounts.txt > counts/GSE228167_Rep2_Counts.txt 
